		...
		<div class="col-xs-12 col-md-8">
			<div class="row">
				<div class="card col-xs-12 col-md-8 offset-md-2">
					<img class="img-fluid" src="<?php esc_attr_e( SBMD_THEME_DIR_URI ); ?>/img/404.png">
					<div class="card-body">
						<h4 class="card-title"><?php esc_html_e( '404 - Not found', 'seabadgermd' ); ?></h4>
						<p class="card-text"><?php esc_html_e( 'Sorry, the content you are looking for is not available.
